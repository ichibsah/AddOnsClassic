...
Seems that the original author has abandoned the AddOn, and since
Legion has broke it I've debug the code and fix it to get it working
again.

My idea is not to take over this AddOn, but I'll maintain it until
